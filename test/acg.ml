...
let () = assert (App (constant_term, constant_app) = normalised_term double_redex_term)
let () = assert (App(constant_app, App(constant_term, constant_app)) = normalised_term (App(redex_term, double_redex_term)))
